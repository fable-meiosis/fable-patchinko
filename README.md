# Fable patchinko bindings: WIP

Fable bindings for [Patchinko](https://github.com/barneycarroll/patchinko) state patching library.

## Why?

Patchinko can be used with the excellent [Meiosis pattern](https://meiosis.js.org/) as a building block for next gen _elmish_ like architecture.
